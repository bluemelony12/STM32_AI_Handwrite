...
#define AI_NETWORK_MODEL_SIGNATURE     "0xa87fa77c066233448f4d4cfa8ba0bb0d"
...
#define AI_TOOLS_DATE_TIME   "Wed Jun 12 23:43:09 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 28, 2), AI_STRIDE_INIT(4, 4, 4, 128, 3584),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 14, 2), AI_STRIDE_INIT(4, 4, 4, 256, 3584),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 3136, 100, 1, 1), AI_STRIDE_INIT(4, 4, 12544, 1254400, 1254400),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1334104, 1, 1),
    1334104, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 39744, 1, 1),
    39744, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_conv2d_10_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_7_output),
  &conv2d_0_layer, 0xd0794de7, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_conv2d_10_input0_output_array.data = AI_PTR(g_network_activations_map[0] + 29440);
    serving_default_conv2d_10_input0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 29440);
    conv2d_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 32576);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 32576);
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 4352);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4352);
    conv2d_2_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 29440);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 29440);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 12544);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12544);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 1152);
    conv2d_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1152);
    ...
    conv2d_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 75008);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 75008);
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 75264);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 75264);
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 1329664);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1329664);
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 1330064);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1330064);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 1334064);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1334064);
    return true;
  }
